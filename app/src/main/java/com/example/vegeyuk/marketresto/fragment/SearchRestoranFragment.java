...
public class SearchRestoranFragment extends Fragment {
    ...
    public static SearchRestoranFragment newInstance() {
        return new SearchRestoranFragment();
    }
    ...
    private void initViews(View view) {
        ...
        if (restoranList.size() == 0) {
            ...
            adapter = new RestorantAdapter(getActivity(), restoranList);
